...
import Controller.MantenimientoNotasController;
import Model.Note;
 ...
 */
public class MantenimientoNotas extends javax.swing.JFrame {
    
    MantenimientoNotasController noteManager = new MantenimientoNotasController();
    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");

    /**
     * Creates new form MantenimientoNotas
     */
    ...
    public void loadProductos(){
        ...
        for (Map.Entry<LocalDateTime, Note> entry : noteManager.getBookMap().entrySet()) {
            ...
            sb.append("Date: ").append(entry.getKey().format(formatter)).append("\n");
            sb.append("Nombre: " + nota.getName()).append("\n\n");
            sb.append(nota.getMessage()).append("\n\n");
            sb.append(nota.getUpdateAt().format(formatter).toString()).append("\n \n");
            sb.append("------------------------------------------").append("\n \n");    
        }
        
        jtxtNotes.setText(sb.toString());
    }
    ...
    private void initComponents() {
        ...
        cbSelectNote = new javax.swing.JComboBox<>();
        ...
        jtxtNotes.setEditable(false);
        jtxtNotes.setColumns(20);
        jtxtNotes.setLineWrap(true);
        jtxtNotes.setRows(5);
        jScrollPane1.setViewportView(jtxtNotes);

        cbSelectNote.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel2.setText("Select the note:");

        jLabel3.setText("Title of note:");

        txtMessage.setColumns(20);
        txtMessage.setRows(5);
        jScrollPane2.setViewportView(txtMessage);

        jLabel4.setText("Messsage of note:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(65, 65, 65)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbSelectNote, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnDeleteNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteNoteActionPerformed
        ...
        if(cbSelectNote.getSelectedIndex() == 0) return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenimientoNotas().setVisible(true);
            }
        });
    }
